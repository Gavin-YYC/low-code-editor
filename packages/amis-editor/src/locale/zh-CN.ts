...
extendLocale('zh-CN', {
  ...
  '2d05187a27548818d216542e4be6dffc': '模板.xlsx',
  '79b6a09991fab89b51eae1961b3114e2': '导出模板.xlsx',
  '65f750ca4eba94a00a38643cb5f38be9': '批量导出.xlsx',
  ...
  'ab38465c84ef2a90bec7e86ec03dc94d': '数据请求方式',
  '33e9b56baa39ccd8cad264ca20651ab2': '调用工具',
  '63edd678c0b5ff3dfa733ce2735c2010': '手动添加',
  '3ac5f53ea8f6ac86214909fa931aa48d': '手动添加数据',
  '94b5f4c3b5fc324d09114e0c89c4c8e7': '添加数据',
  'b545d6529d2558290291583b3e7237dc': '请输入当前列的数据',
  ...
  '27a38fdb94f79567ed1eaefb7d1e8782': '使用工具',
  'f2166a565ef29caa64827dbf5a98159d':
    '是否使用工具返回的结果，若是，则工具返回结果后将自动渲染。不支持自定义编辑',
  'a998bd6bd5b057b59067d117a3dce230': '绑定工具',
  ...
  '8fce93da0f38ab453ee89ba8b6a505dc': '自定义表格',
  '606c8c7399d5c3b86c88a25b6748bd1f': '这只是个示例',
  'a01a9963238df560a9b974f45c7e253a': '年龄',
  '427f2a3f6a96c56cfe876c1d1d2d03f1': '请输入每一行的数据，使用&符号分隔',
  '6fce1c9aa3654ae2f0eedcc068a7e189': '自定义组件',
  'd141cc6203a90a2ce2f9008e125f6d16': '固定表头',
  '5223b168be67e01e32db73b39b1af35d': '展示序号',
  '377654c26c08e841d4589075fef6d050': '列宽可调整',
  '9969614487f9bf68da5b5f46117356e7': '弹出方式',
  '86dbfaf290d218967e17a8e526da5dd4': '触发确认操作',
  '1e02e4ae26c2d491dc1a795841b69264': '自定义图表',
  '398e9fff43cd7b673eace3a7fe2f3620': '快速构建图表数据',
  'ce28347faa7b7fb0e2197a45fdf9690c': '自定义配置',
  '7aed240846509a3b884367466f1d6284': '图表类型',
  'd5e33db767905b39b98b37328dfdbe49': '饼图',
  'c9c9bd875be1517ebc5951d1e6157c7d': '折线图',
  '7c8ee6e3ac16efb820e7b196e6598808': '柱状图',
  '195a0567268e50d838264ca82d0be5d8': '类目',
  '531aadcd96c4f39b3e50e482e8dbd087': '数值',
  '29e4670103e9cae073ad9b3d3b7f1636': 'X轴类别',
  '1f46cd83756eda45d954309db3b20c52': 'Y轴数据',
  'c11e5dcd3250799487782b4e17638327': 'X轴单位',
  'a89f8699340d12ca2639f7923e286882': 'Y轴单位',
  '04f5ce128266f98fda7c68270c0f4a12': '线段颜色',
  '8007a150639069bbf71183eaa8d82fcf': '线条类型',
  'ca43740ce36b6ecd1aab5d70613de37a': '显示标记点',
  'aedb1321a85ac3385911585bb5b04b68': '标记颜色',
  '33084b2496c8ad306e5b2e6d63bb5886': '面积填充',
  'faef1f716351198583e329accabc71c5': '填充颜色',
  'a9d7ad226af3f4ab612f6c063fb512c2': '半径配置',
  'a51d9963bf4fbf663bae30314f70b1ef': '格式: 外半径|内半径 (示例: 50%|30%)',
  '3134a50ff2de0cc68421d425b5d23b29': '中心位置',
  'ba51a9ed77afc8729e1d5f8dabc352b6': '格式: 水平位置|垂直位置 (示例: 50%|50%)',
  '624952f3a4c833893454db4ec21a7318': '显示标签',
  '0a6bfb272dbc96746b7d4ff0f12ebd6e': '标签颜色',
  'f568f2b663985778e5f944ea405334d2': '柱条颜色',
  '267d2c6459a1ef4152ad178ce65f1d9b': '柱条宽度',
  '9b0c482ee3d922801ee8bb4c47dc41eb': '数值或百分比（示例：30 或 40%）',
  '274e15286581279a070628da1751f644': '显示数值标签',
  ...
  'e0da84f9ec4712575b5212c7e2538191': '图片来源',
  'bc3916f0cd635e3e915d5040c474f319': '切换图片来源将清空绑定值',
  'b4af786af038f807f8d7a2b279f72c0d': '本地上传',
  '28acfdc9d9745dc8d188a626bdeaf52b': '绑定数据',
  'd979b9ebd6cef092760a23c868c35500': '填写图片地址，支持使用变量。',
  ...
  '2660dbeb80c1273cfccabd13649fdadc':
    "/* 自定义JS使用说明：\n      * 1.动作执行函数doAction，可以执行所有类型的动作\n      * 2.通过上下文对象context可以获取当前组件实例，例如context.props可以获取该组件相关属性\n      * 3.事件对象event，在doAction之后执行event.stopPropagation();可以阻止后续动作执行\n      */\n      const myMsg = '我是自定义JS';\n      doAction({\n      actionType: 'toast',\n      args: {\n      msg: myMsg\n      }\n      });\n      ",
  '6c5901e40495d9e8af1cd92537962fa3': '内部跳转',
  'eeb426a0421aa6bc26d1fbe9efb8ea84': '内部链接',
  'f5a775f0a4fc67da2e9b9815904ba299': '调用已添加的工具，获取工具返回的数据',
  '59f941ba0109bd2753306e69f63251a8': '工具：',
  'e577f6aa6630813288b4b22a15e219b3': '选择工具',
  '1b705849372489ad649bfaf65bec85f2':
    '选择已添加的工具，包括工作流工具和OpenAPI schema工具。若没有，请在业务逻辑页面进行添加',
  '00ba499d75b60c2f5066664e848f16fa': '请求入参',
  '93783a6d3ad61142a47b56670e24afe1':
    '选择工具所需的参数名作为key，组件绑定的值作为value。动态值为\\${value}的形式',
  '33064b4acbc1d6750399b04e1c55f290': '请选择工具的参数名',
  ...
  '4964e8347a5fc4603da9632ec0289004': '认证失败，无法访问系统资源',
  '5f4a4acb89d110433f2390c9fdc65128': '当前操作没有权限',
  '51b4b1954ef66c74337b755b6d3c9ec2': '访问资源不存在',
  '481d3c1a040d055da8b399ea44bc8097': '系统未知错误，请反馈给管理员',
  'acafb436a76f02abe2b583712f5ad167':
    '无效的会话，或者会话已过期，请重新登录。',
  '70d2d043e4369d80262764e43af8646c': '后端接口连接异常',
  'c6a730c3c686ea3674dc9a4b8ac9165e': '系统接口请求超时',
  '63e046eb678271fa61f59b30c529a768': '系统接口{{@1}}异常',
