...
export const getToken = () => {
  ...
  const token =
    ...
    (import.meta.env.MODE !== 'development'
      ? null
      : 'eyJhbGciOiJIUzUxMiIsInppcCI6IkdaSVAifQ.H4sIAAAAAAAAAF2QS07DMBCG7-J1guzGdZqsWCCkCtRNywEm9pAYEjvyQ4VWPQrcj1vg0BewnG_-_5_HnrwETWryTJGBkiKnsuE5L8smbwBUTotKVEUFXCpJMqIhkJqVnAo-o-UsIz42ye3ffcBh6nufSjuig6CtSQSiOpEnjy4BfBt_ItiMi8UUEdCACctJxhaiWAhWcErnFVswOqfJEZPx3OZVWZZCzCmjnDLOUvuSXe-JTjIT-z4j0iEE3OgBzySO6h9R2N_30JKaZsTAxMmui3aL-jR1BVfxCN5vrbsMwAF0f3Xcyk6blN-jtMONnE4fO2twFYdm2u1oSruapfpdrW108jLEYavTK91f-qydD4-21YbUwUXMSBN315gOQS0HaE_6Q3qpfUVzPI18fXyu7x42EyGHb-cLvGnvAQAA._IqjNB0D9w1z-Ja3enxjRkMhT3C4FIlkpBu3s5nPih0f6DfM-s5x2md2izj_Xn2oqQqf-P1JN36SQkonK_dVgg');
  return amisEditorProps?.token || token;
};

// 无权限跳转首页
export const redirectInit = () => {
  console.log(window.$wujie);
  window.$wujie?.bus.$emit('redirect', 'apps');
};
